        ...
        Row(horizontalArrangement = Arrangement.Start) {
            ...
            Surface(modifier = Modifier.padding(0.dp, 0.dp, 10.dp, 0.dp)) {
                ...
                val image = rememberCoilPainter(
                    request = movie.imageUrl?: "https://picsum.photos/id/1026/60/90",
                    fadeIn = true)
                Image(
                    painter = image,
...
@Composable
fun FavoritesMovieRowPreview() {
    FavoritesMovieRow(movie = Constants.fakeFavoriteMovie, onItemClick = {})
}